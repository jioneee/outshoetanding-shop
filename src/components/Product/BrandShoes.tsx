...
const ConverseImage: ProductImg[] = [
  ...
  { id: 1, title: 'shoes4', image: 'https://www.converse.co.kr/web/product/big/202307/68a88e51c6a90d123a54d2ba05eb887f.jpg', price: 50000 },
];
...
export const Nike = () => {
  ...
  const { seletedPrice, setSelectedPrice } = useState(0);

  const handleAddToCartClick = (img: any, price: number) => {
    setSelectedImg(img);
  ...
  return (
    <div>
      <ProductListWrap>
        ...
        {isOpenModal && selectedImg !== null && <Modal onClick={clickCloseModal} img={selectedImg} price={seletedPrice} onAddToCart={() => {}} />}
      </ProductListWrap>
    </div>
  );
};
